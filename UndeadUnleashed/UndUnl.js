...
code: {
    ...
    let playerWeapon;
    let swingSpeed = 6;
    let defaultZHealthMin = 20;
    let defaultZHealthMax = 100;
    let swordKnockBack = 3;
    let playerMaxHealth = 80; // temporary health value
    let playerDamage = 10; // temporary damage value
    let playerSpeed = 4; // temporary speed for home screen
    let queueNum = 0;
    let gameDifficulty = 'Normal';
    let startButton;
    let difficultyButton;
    let zombieSpeed = 1;
    let zombieSpawnOffSet = 100;
    let zombieSpawnRate = 6;
    let speedSlider;
    let speedIcon;
    let healthSlider;
    let healthIcon;
    ...
    function deathSetup() {
        ...
        fb_saveScore(score, "ULscore", "UndeadUnleashedHS");
        //restartButton.style
    }
    //restets that game
